...
​5
​​ ), indicating the number of coins.

The second line contains a string A=a
​1
​​ a
​2
​​ ⋯a
...
​​  (a
​i
​​ ∈{‘0’,‘1’}) indicating the initial state of each coin. The i-th coin has its head facing upward in the initial state if a
​i
​​ =‘0’, and has its tail facing upward otherwise.

The third line contains a string B=b
​1
​​ b
​2
​​ ⋯b
...
​​  (b
​i
​​ ∈{‘0’,‘1’}), indicating the desired state of each coin. The i-th coin has its head facing upward in the desired state if b
​i
​​ =‘0’, and has its tail facing upward otherwise.

It's guaranteed that the sum of n of all test cases will not exceed 5×10
​5
​​ .

有多组测试数据。第一行输入一个整数 T 代表测试数据组数。对于每组测试数据：

第一行输入一个整数 n (1≤n≤105)，代表硬币的数量。
...
​​ ∈{‘0’,‘1’}) 代表每枚硬币的目标状态。若 b
​i
​​ =‘0’ 则第 i 枚硬币的目标为正面朝上，否则为背面朝上。

保证所有数据的 n 之和不超过 5×10
​5
​​ 。
